...
export const agentConfig: Record<AgentType, { label: string; abbr: string; badgeClass: string; avatarClass: string; icon: string }> = {
  main:     { label: '한성 AI',      abbr: 'AI',   badgeClass: 'badge-main',     avatarClass: 'avatar-main',     icon: '🎓' },
  library:  { label: '학술정보관 AI', abbr: '도서',  badgeClass: 'badge-library',  avatarClass: 'avatar-library',  icon: '📚' },
  document: { label: '문서 결재 AI', abbr: '결재',  badgeClass: 'badge-document', avatarClass: 'avatar-document', icon: '📋' },
};
