...
const MENUS: { id: number; Icon: LucideIcon; label: string; url: string }[] = [
	...
	{ id: 2, Icon: Globe, label: "인터넷 전자조달", url: "https://www.ebiz4u.co.kr/home.do" },
	{
		id: 3,
		Icon: BookOpen,
		label: "학술정보관",
	...
	{ id: 4, Icon: Briefcase, label: "대학 일자리 플러스 센터", url: "https://career.hansung.ac.kr/" },
	{ id: 5, Icon: FileCheck, label: "제증명 발급", url: "https://career.hansung.ac.kr/" },
	{ id: 6, Icon: Megaphone, label: "공지사항", url: "https://www.hansung.ac.kr/hansung/6172/subview.do" },
	{
		id: 7,
		Icon: MonitorPlay,
		label: "eclass",
	...
	{ id: 8, Icon: GraduationCap, label: "종합정보시스템", url: "https://info.hansung.ac.kr/" },
	{ id: 9, Icon: Gift, label: "장학금 안내", url: "https://hansung.ac.kr/edubank/5762/subview.do" },
	{
		id: 10,
		Icon: Building2,
		label: "공간예약",
	...
	{ id: 11, Icon: CalendarDays, label: "학사일정", url: "https://www.hansung.ac.kr/hansung/6096/subview.do" },
	{ id: 12, Icon: FlaskConical, label: "연구정보", url: "https://hansung.ac.kr/sites/rnd/index.do" },
];
